...
def main(file_path1, file_path2, file_path3):
    ...
    plt.plot(total_numsteps_smoothed2, smoothed_rewards2, label='LIF: Smoothed Rewards', color='green')
    plt.plot(total_numsteps_smoothed3, smoothed_rewards3, label='IZH: Smoothed Rewards', color='red')
...
file_path2 = 'results/result_LIF.txt'  # Replace with the actual path to your second text file
file_path3 = 'results/result_IZH.txt'
